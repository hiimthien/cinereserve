<template>
  <div class="space-y-3 max-w-2xl mx-auto my-6 px-4">
    <!-- Seat Types & Pricing Legend -->
    <div class="flex flex-wrap items-center justify-center gap-4 sm:gap-6 py-2.5 px-4 bg-cinema-surface/70 backdrop-blur-md rounded-2xl border border-cinema-border text-xs">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-slate-300 font-medium">Ghế Thường <span class="text-[11px] text-cinema-muted">(95.000 đ)</span></span>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-amber-300 font-bold">Ghế VIP Prime <span class="text-[11px] text-amber-400/80">(115.000 đ)</span></span>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-pink-300 font-bold">Ghế Đôi Sweetbox <span class="text-[11px] text-pink-400/80">(220.000 đ)</span></span>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center justify-center gap-4 sm:gap-6 py-2 px-4 bg-black/30 backdrop-blur-sm rounded-xl border border-white/5 text-[11px] text-cinema-muted">
      ...
      <div class="flex items-center gap-1.5">
        ...
        <span class="text-amber-300 font-bold">Đang giữ chỗ (Realtime 10p)</span>
      </div>
